...
class UpdateModule(nn.Module):
    ...
    def forward(self, net, inp, corr, flow=None, ii=None, jj=None, objmask=None):
        ...
        #TODO-GRG : Need to modify this
        weight = self.weight(net).view(*output_dim)

        # #TODO-GRG : Change

        objmask = objmask.squeeze(0)
        ...
        if ii is not None:
            ...
            return net, delta, weight, eta, upmask, objmask
